...
public class RecycleNavi extends RecyclerView.Adapter<RecycleNavi.MyViewHolder>{

    Context context;
    ArrayList<Player> player;

    public RecycleNavi(Context c, ArrayList<Player> p ){
        context = c;
        player = p;
    }

    public RecycleNavi.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new RecycleNavi.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.cardview_team,viewGroup, false));
    }

    public void onBindViewHolder(@NonNull RecycleNavi.MyViewHolder holder, int position) {
