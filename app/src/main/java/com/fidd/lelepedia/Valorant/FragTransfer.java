...
public class FragTransfer extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.transfer_valorant,container,false);
    ...
    private void transferPlayer(){
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("valorant").child(playerNickname);
