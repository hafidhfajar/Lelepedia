...
public class RecycleBDS extends RecyclerView.Adapter<RecycleBDS.MyViewHolder>{

    Context context;
    ArrayList<Player> player;

    public RecycleBDS(Context c, ArrayList<Player> p ){
        context = c;
        player = p;
    }

    public RecycleBDS.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new RecycleBDS.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.cardview_team,viewGroup, false));
    }

    public void onBindViewHolder(@NonNull RecycleBDS.MyViewHolder holder, int position) {
