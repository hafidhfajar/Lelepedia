...
public class RecycleOG extends RecyclerView.Adapter<RecycleOG.MyViewHolder>{

    Context context;
    ArrayList<Player> player;

    public RecycleOG(Context c, ArrayList<Player> p ){
        context = c;
        player = p;
    }

    public RecycleOG.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new RecycleOG.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.cardview_team,viewGroup, false));
    }

    public void onBindViewHolder(@NonNull RecycleOG.MyViewHolder holder, int position) {
