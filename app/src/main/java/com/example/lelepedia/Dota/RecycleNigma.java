...
public class RecycleNigma extends RecyclerView.Adapter<RecycleNigma.MyViewHolder>{

    Context context;
    ArrayList<Player> player;

    public RecycleNigma(Context c, ArrayList<Player> p ){
        context = c;
        player = p;
    }

    public RecycleNigma.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new RecycleNigma.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.cardview_team,viewGroup, false));
    }

    public void onBindViewHolder(@NonNull RecycleNigma.MyViewHolder holder, int position) {
