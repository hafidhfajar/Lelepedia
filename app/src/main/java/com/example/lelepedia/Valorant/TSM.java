...
public class TSM extends AppCompatActivity {

    private RecyclerView recyclerView;
    private RecycleTsm adapter;
    private ArrayList<com.example.lelepedia.Dota.Player> list;
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            if(dataSnapshot.exists()){
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    com.example.lelepedia.Dota.Player player = snapshot.getValue(Player.class);
                    list.add(player);
                }
